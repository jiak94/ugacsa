...
<div id="hd">
	...
	<div style="width: 80px;">
		...
		<!--{if $_G[uid]}--><a href="home.php?mod=space&uid={$_G[uid]}" id="dsm_side_open" class="pic"><!--{if $_G[member][newpm] || $_G[member][newprompt] || $_G[member][newprompt_num][follower] || $_G[member][newprompt_num][follow]  }--><span class="pm"></span><!--{/if}--><!--{avatar($_G[uid],small)}--></a>
		<!--{else}-->
