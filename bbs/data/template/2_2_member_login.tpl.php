...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1409798854, '2', './data/template/2_2_member_login.tpl.php', './template/singcere_watch', 'member/login')
