...
0
|| checktplrefresh('./template/singcere_watch/common/header.htm', './template/default/common/header_common.htm', 1410226982, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/singcere_watch', 'common/header_home_spacecp')
|| checktplrefresh('./template/singcere_watch/common/header.htm', './template/singcere_watch/common/pubsearchform.htm', 1410226982, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/singcere_watch', 'common/header_home_spacecp')
;?>
