...
0
|| checktplrefresh('./template/singcere_watch/common/header.htm', './template/default/common/header_common.htm', 1409798810, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/singcere_watch', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/singcere_watch/common/header.htm', './template/singcere_watch/common/pubsearchform.htm', 1409798810, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/singcere_watch', 'common/header_forum_forumdisplay')
;?>
