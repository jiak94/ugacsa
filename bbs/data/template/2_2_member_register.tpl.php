...
0
|| checktplrefresh('./template/default/member/register.htm', './template/default/common/seccheck.htm', 1410488059, '2', './data/template/2_2_member_register.tpl.php', './template/singcere_watch', 'member/register')
...
<th>&nbsp;</th>
<td class="tipwide">
注册需要@uga.edu邮箱进行验证.<br />如果您没有@uga.edu邮箱请联系李嘉宽(jiak94@uga.edu)进行注册<br />您可能需要等待几分钟才能收到邮件，如果收件箱没有，请检查一下垃圾邮件箱。
</td>
</tr>
</table>
