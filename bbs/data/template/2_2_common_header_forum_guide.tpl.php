...
0
|| checktplrefresh('./template/singcere_watch/common/header.htm', './template/default/common/header_common.htm', 1409787807, '2', './data/template/2_2_common_header_forum_guide.tpl.php', './template/singcere_watch', 'common/header_forum_guide')
|| checktplrefresh('./template/singcere_watch/common/header.htm', './template/singcere_watch/common/pubsearchform.htm', 1409787807, '2', './data/template/2_2_common_header_forum_guide.tpl.php', './template/singcere_watch', 'common/header_forum_guide')
;?>
