...
0
|| checktplrefresh('./template/singcere_watch/common/header.htm', './template/default/common/header_common.htm', 1409785706, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/singcere_watch', 'common/header_home_space')
|| checktplrefresh('./template/singcere_watch/common/header.htm', './template/singcere_watch/common/pubsearchform.htm', 1409785706, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/singcere_watch', 'common/header_home_space')
;?>
