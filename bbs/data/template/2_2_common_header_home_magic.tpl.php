...
0
|| checktplrefresh('./template/singcere_watch/common/header.htm', './template/default/common/header_common.htm', 1410260461, '2', './data/template/2_2_common_header_home_magic.tpl.php', './template/singcere_watch', 'common/header_home_magic')
|| checktplrefresh('./template/singcere_watch/common/header.htm', './template/singcere_watch/common/pubsearchform.htm', 1410260461, '2', './data/template/2_2_common_header_home_magic.tpl.php', './template/singcere_watch', 'common/header_home_magic')
;?>
