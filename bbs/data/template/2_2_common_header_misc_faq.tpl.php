...
0
|| checktplrefresh('./template/singcere_watch/common/header.htm', './template/default/common/header_common.htm', 1410303065, '2', './data/template/2_2_common_header_misc_faq.tpl.php', './template/singcere_watch', 'common/header_misc_faq')
|| checktplrefresh('./template/singcere_watch/common/header.htm', './template/singcere_watch/common/pubsearchform.htm', 1410303065, '2', './data/template/2_2_common_header_misc_faq.tpl.php', './template/singcere_watch', 'common/header_misc_faq')
;?>
