...
<?php if(!empty($_G['setting']['pluginhooks']['index_side_top'])) echo $_G['setting']['pluginhooks']['index_side_top'];?>
      ...
      <div id="right_column" class="column"> 
        ...
        <div id="special_block_right" class="block products_block exclusive blockspecials">
          <h4><a href="home.php?mod=spacecp">我的资料</a></h4>
          <div class="block_content">
            <ul class="products">
              <li class="ajax_block_product"> <a class="product_image" href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>"><?php echo avatar($_G[uid],big);?></a>
                <div> <a class="exclusive ajax_add_to_cart_button" href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>&amp;do=thread&amp;view=me&amp;from=space"><span class="addtocard">我发表的帖子</span></a> </div></li>
            </ul>
          </div>
        </div>
        <!-- /MODULE Block specials --> 
